...
final class AdminRendezVousController extends AbstractController
{
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('admin_rendez_vous/new.html.twig', [
    ...
    {
        return $this->render('admin_rendez_vous/show.html.twig', [
            'rendez_vou' => $rendezVou,
        ]);
    }
    ...
    public function edit(Request $request, RendezVous $rendezVou, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('admin_rendez_vous/edit.html.twig', [
            'rendez_vou' => $rendezVou,
            'form' => $form,
        ]);
    }
